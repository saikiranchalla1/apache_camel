...
public class OrderService {
    ...
    public void toSoap(Exchange exchange) {
        ...
        if (body.contains("ActiveMQ in Action")) {
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("camelnp/soapFault.xml");
            ...
            InputStream is = exchange.getContext().getClassResolver().loadResourceAsStream("camelnp/soapOk.xml");
            Document dom = exchange.getContext().getTypeConverter().convertTo(Document.class, is);
