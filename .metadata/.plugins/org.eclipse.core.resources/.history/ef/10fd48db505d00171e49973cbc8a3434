 ...
 * Each of those message is then translated into a quote using the {@link camelnp.WordTranslateBean} bean.
 * The Splitter will then aggregate those messages into a single combined outgoing message.
 * This is done using the {@link camelnp.MyAggregationStrategy}.
 *
 * @version $Revision$
 */
