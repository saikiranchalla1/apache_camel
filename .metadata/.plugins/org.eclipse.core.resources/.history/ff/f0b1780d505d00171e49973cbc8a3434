...
public class OrderEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://order.camelnp", "OrderEndpointService");
    public final static QName OrderService = new QName("http://order.camelnp", "OrderService");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/SaiKiran/Downloads/camelnp-master/chapter7/cxf/contract_first/src/main/resources/wsdl/order.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/SaiKiran/Downloads/camelnp-master/chapter7/cxf/contract_first/src/main/resources/wsdl/order.wsdl");
        }
        WSDL_LOCATION = url;
    }
